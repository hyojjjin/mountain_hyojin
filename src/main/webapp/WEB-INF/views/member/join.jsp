...
<script>
	$(document).ready(function() {
        ...
        function setLocInput() {
        	var loc = $("#sample3_postcode").val() + "|" + $("#sample3_address").val() + $("#sample3_detailAddress").val() + " " +
...
<!--    <input type="text" name="email" class="form-control" id="email"> -->
        ...
        <input type="text" id="email" value="" placeholder="이메일 입력" pattern="[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}"> 
 		<span>@</span>
